...
module "vnet" {
  ...
  virtual_network_name = "polaris_vnet1"
...
module "bastion" {
  depends_on = [module.resource_group_name, module.vnet, module.public_ip, module.subnet]
  source     = "../module/azurerm_bastion"

  bastion_name        = "polaris-bastion"
  location            = "Japan East"
  rg_name             = "polaris_rgroup"
  public_ip           = "polaris_pip_bastion"
